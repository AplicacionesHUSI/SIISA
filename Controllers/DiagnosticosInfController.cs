...
namespace HUSI_SIISA.Controllers
{
    ...
    public class DiagnosticosInfController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("ActualizarDx")]
        private ActionResult ActualizarDx([FromBody] DiagnosticosRequest dxActualizar)
        {
...
#pragma warning restore CS8602 // Desreferencia de una referencia posiblemente NULL.
        ...
        [HttpPost]
        [Route("InsertarDx")]
        private ActionResult InsertarDx([FromBody] DiagnosticosRequest dxOrigen)
        {
            ...
            ValidacionNotas objNotas = utilLocal.ValidaConsulta(dxOrigen.IdConsulta, "4", dxOrigen.IdAtencion);
...
#pragma warning restore CS8602 // Desreferencia de una referencia posiblemente NULL.
                        ...
                        using (SqlConnection conexion = new(conn.getCs()))
                        {
                            ...
                            logSahico.Info("********************* Valor de tipoNota:" + 820 + "  Nota:" + NumeroNota + "   Atencion:" + dxOrigen.IdAtencion + "****************************");
