...
namespace HUSI_SIISA.Controllers
{
    ...
    public class RipsController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("EnvioRips")]
        public ActionResult EnvioRips([FromBody] RipsModel RipsRequest)
        {
            RipsModelRespuesta ripsrespuesta=new RipsModelRespuesta();
            ripsrespuesta.Estado = true;
            ripsrespuesta.Descripcion = "Exitoso";

            return Ok(ripsrespuesta);
            /*
            try
            {
